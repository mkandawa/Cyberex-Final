...
using System.Web;
    ...
    public sealed class DBManager : IDBManager, IDisposable
    {
        ...
        public DBManager(string odbc)
        {
            this.ConnectionString = Helper.GetDBConnectionString();
        ...
        public void AddParameters(int index, string paramName, object objValue, int direction)
        {
    ...
    IDbDataParameter[] commandParameters)
        ...
        //    this.idbCommand = DBManagerFactory.GetCommand(this.ProviderType);
        //    PrepareCommand(idbCommand, this.Connection, this.idbTransaction ,
        //    commandType, commandText, this.Parameters);
        //    int returnValue = idbCommand.ExecuteNonQuery();
        //    idbCommand.Parameters.Clear();
        //    return returnValue;
